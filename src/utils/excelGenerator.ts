 ...
 * - Stamp image placed ABOVE the Authorized Signature text line (matching PDF)
...
export async function generateExcelDocument(options: ExcelGeneratorOptions): Promise<void> {
  ...
  // =========================================================================
  // PRE-FETCH STAMP IMAGE (IF APPLICABLE)
  // =========================================================================
  let stampImageId: number | null = null;
  const hasStamp = currentCompany.hasStamp && !!currentCompany.stampUrl;
  ...
  pages.forEach((page) => {
    ...
    // Embed Stamp Image centered perfectly between "For [Company]" and "Authorized Signature"
    if (stampImageId !== null && !isChallan) {
