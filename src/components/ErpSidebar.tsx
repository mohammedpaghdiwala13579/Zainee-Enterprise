              ...
              <div className="flex items-center gap-2.5 overflow-hidden">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-[10px] text-slate-400 truncate">
                    Hardware & Machineries ERP
                  </span>
                </div>
              </div>
            ) : (
              <div className="mx-auto">
                <div className="h-8 w-8 rounded-full border border-slate-700 overflow-hidden bg-white flex items-center justify-center shadow-xs">
                  <img 
                    src="https://i.ibb.co.com/V8VJdXK/123.png" 
                    alt="Zainee Enterprise Logo" 
                    className="h-full w-full object-contain p-0.5" 
