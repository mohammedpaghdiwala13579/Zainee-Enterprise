          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[12px] font-semibold tracking-wide flex items-center gap-2">
                <span>ZAINEE ENTERPRISE TERMINAL</span>
            ...
            <div className="space-y-3 my-4">
              ...
              {platform === "ios" ? (
                ...
                <div className="bg-slate-50 p-3.5 rounded border border-slate-200 text-xs space-y-2.5">
                  ...
                  <p className="text-[10px] text-slate-500 italic mt-1">This will place the Zainee Enterprise icon right in your Mac Dock!</p>
                </div>
              ) : (
